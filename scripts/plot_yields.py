...
if __name__ == "__main__":
    ...
    parser.add_argument('-v', '--variable', type=str, default="mass", choices=["mass", "atomic_number", "compactness"], help="The x-axis variable. Options: 'mass', 'atomic_number', 'compactness")
